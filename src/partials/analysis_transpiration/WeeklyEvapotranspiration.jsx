...
function WeeklyEvapotranspiration({ plantData = [] }) {
  ...
  const yScale = (value) => height - (value / 1) * height;  // Assuming max value is 1 mm/h
...
export default WeeklyEvapotranspiration;