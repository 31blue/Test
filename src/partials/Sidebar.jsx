        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <ul className="mt-3">
                      ...
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className={`shrink-0 fill-current ${pathname === "/" || pathname.includes("dashboard") ? 'text-green-500' : 'text-gray-400 dark:text-gray-500'}`} xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16">
              ...
              {/* Album */}
              <li className={`pl-4 pr-3 py-2 rounded-lg mb-0.5 last:mb-0 bg-[linear-gradient(135deg,var(--tw-gradient-stops))] ${pathname.includes("campaigns") && "from-green-500/[0.12] dark:from-green-500/[0.24] to-green-500/[0.04]"}`}>
                <NavLink
                  end
                  to="/album"
                  className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
