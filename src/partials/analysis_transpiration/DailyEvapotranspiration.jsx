  ...
  return (
    <div className="col-span-full xl:col-span-8 bg-white dark:bg-gray-800 shadow-lg rounded-sm border border-gray-200 dark:border-gray-700">
      <header className="px-5 py-4 border-b border-gray-100 dark:border-gray-700">
        <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-100">오늘의 증발산량</h2>
      </header>
      <div className="p-3">
        ...
        <div className="flex-grow">
          <BarChart01 data={evapotranspirationData} width={595} height={248} />
        </div>
      </div>
    </div>
  );
